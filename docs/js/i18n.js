(function () {
  ...
  const I18N = {
    en: {
      ...
      practicePageLede: "A few quick, fun exercises to test what you've learned. Type your answer, check it, and move on — no pressure, no score.",
    ...
    fr: {
      ...
      practicePageLede: "Quelques exercices rapides et ludiques pour tester ce que tu as appris. Tape ta réponse, vérifie-la, et passe à la suite — pas de pression, pas de score.",
    ...
    de: {
      ...
      practicePageLede: "Ein paar kurze, spielerische Übungen, um dein Wissen zu testen. Tippe deine Antwort, überprüfe sie und mach weiter — kein Druck, keine Punktzahl.",
