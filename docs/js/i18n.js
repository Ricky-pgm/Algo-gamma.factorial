(function () {
  ...
  const I18N = {
    en: {
      ...
      practGammaUse: "The Gamma probability distribution uses Γ(a) as a normalizing constant, so its total probability adds up to 1. For example, Γ(1/2) = √π ≈ 1.7725.",
    ...
    fr: {
      ...
      practGammaUse: "Dans la loi de probabilité Gamma, Γ(a) sert de constante de normalisation, pour que la probabilité totale fasse bien 1. Par exemple, Γ(1/2) = √π ≈ 1,7725.",
    ...
    de: {
      ...
      practGammaUse: "In der Gamma-Wahrscheinlichkeitsverteilung dient Γ(a) als Normierungskonstante, damit sich die Gesamtwahrscheinlichkeit zu 1 summiert. Zum Beispiel ist Γ(1/2) = √π ≈ 1,7725.",
