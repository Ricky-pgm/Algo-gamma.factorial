(function () {
  ...
  const I18N = {
    en: {
      ...
      domainEverydayExpandExample: "Example: a bridge hand deals 13 cards to each of 4 players from a 52-card deck; the number of possible hands for a single player is C(52,13) = 635,013,559,600 — over 8 orders of magnitude more than the 13,983,816 combinations in a 6/49 lottery.",
    ...
    fr: {
      ...
      domainEverydayExpandExample: "Exemple : une main de bridge distribue 13 cartes à chacun des 4 joueurs depuis un jeu de 52 ; le nombre de mains possibles pour un seul joueur est C(52,13) = 635 013 559 600 — plus de 8 ordres de grandeur au-dessus des 13 983 816 combinaisons d'une loterie 6/49.",
    ...
    de: {
      ...
      domainEverydayExpandExample: "Beispiel: Ein Bridge-Blatt teilt 13 Karten an jeden der 4 Spieler aus einem 52-Karten-Deck aus; die Anzahl möglicher Blätter für einen einzelnen Spieler ist C(52,13) = 635.013.559.600 — über 8 Größenordnungen mehr als die 13.983.816 Kombinationen einer 6-aus-49-Lotterie.",
