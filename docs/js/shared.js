(function () {
  ...
  const I18N = {
    en: {
      ...
      domainCSDesc: "Sorting, searching, and combinatorial optimization all revolve around factorials and binomial coefficients.",
      domainCSEx1: "Sorting n items explores up to n! permutations — 52! ≈ 8×10⁶⁷ possible orderings of a deck of cards.",
      domainCSEx2: "Brute-force TSP on 20 cities: 20! ≈ 2.4×10¹⁸ routes to check.",
      domainCSEx3: "Feature selection: choosing 5 features from 20 candidates = C(20,5) = 15504 combinations.",
      domainAI: "AI & Machine Learning",
      domainAIDesc: "Bayesian inference, model selection, and generative models rely heavily on Gamma and Beta functions.",
      domainAIEx1: "Bayesian A/B testing: after 8 successes and 4 failures, your belief about the conversion rate follows Beta(8,4).",
      domainAIEx2: "Variational inference minimizes KL divergence using Gamma(z) as the normalizing kernel of exponential-family posteriors.",
      domainAIEx3: "Cross-validation: C(10,3) = 120 ways to pick 3 test folds from 10.",
      domainStats: "Statistics & Data Science",
      domainStatsDesc: "Hypothesis tests, confidence intervals, and Bayesian posteriors are all built on Gamma and Beta.",
      domainStatsEx1: "The chi-squared distribution with k degrees of freedom is a scaled Gamma(k/2). For k=10: Gamma(5) = 24.",
      domainStatsEx2: "A 95% Bayesian credible interval for a proportion uses Beta(α,β) quantiles.",
      domainStatsEx3: "Permutation tests: the number of ways to assign 12 subjects to two groups of 6 = C(12,6) = 924.",
      domainPhysics: "Physics & Engineering",
      domainPhysicsDesc: "Quantum mechanics, statistical mechanics, and signal processing use Gamma and double factorials constantly.",
      domainPhysicsEx1: "Wick theorem in QFT: contractions of n fields involve (n-1)!! pairings. For 7 fields: 7!! = 105.",
      domainPhysicsEx2: "Volume of a 6-dimensional unit sphere: V₆ = π³/Gamma(4) = π³/6 ≈ 5.1677.",
      domainPhysicsEx3: "Quantum harmonic oscillator: energy level n has n!! normalization factors.",
      domainBio: "Biology & Bioinformatics",
      domainBioDesc: "Sequence analysis, phylogenetics, and population genetics all use generalized factorials.",
      domainBioEx1: "DNA sequence permutations: the number of distinct orderings of 10 nucleotides = 10! = 3,628,800.",
      domainBioEx2: "K-mer counting: choosing 3 positions from a 20-mer = C(20,3) = 1140 possible 3-mers.",
      domainBioEx3: "Allele frequency models use the Beta distribution as a conjugate prior for binomial likelihoods.",
      domainEveryday: "Everyday Life",
      domainEverydayDesc: "Lottery odds, seating arrangements, and probability estimates all involve these functions.",
      domainEverydayEx1: "Lottery odds: picking 6 numbers from 49 gives C(49,6) = 13,983,816 possible tickets.",
      domainEverydayEx2: "Seating 8 guests around a round table: (8-1)! = 7! = 5040 arrangements.",
      domainEverydayEx3: "Estimating a 30% success rate with 10 trials: your prior belief follows Beta(3,7).",
    ...
    fr: {
      ...
      domainCSDesc: "Le tri, la recherche et l'optimisation combinatoire tournent toutes autour des factorielles et des coefficients binomiaux.",
      domainCSEx1: "Trier n éléments explore jusqu'à n! permutations — 52! ≈ 8×10⁶⁷ ordonnements possibles d'un jeu de cartes.",
      domainCSEx2: "Force brute pour le TSP sur 20 villes : 20! ≈ 2,4×10¹⁸ itinéraires à vérifier.",
      domainCSEx3: "Sélection de caractéristiques : choisir 5 features parmi 20 candidats = C(20,5) = 15504 combinaisons.",
      domainAI: "Intelligence artificielle et apprentissage automatique",
      domainAIDesc: "L'inférence bayésienne, la sélection de modèles et les modèles génératifs reposent sur les fonctions Gamma et Bêta.",
      domainAIEx1: "Test A/B bayésien : après 8 succès et 4 échecs, ta croyance sur le taux de conversion suit B(8,4).",
      domainAIEx2: "L'inférence variationnelle minimise la divergence KL en utilisant Gamma(z) comme noyau de normalisation.",
      domainAIEx3: "Validation croisée : C(10,3) = 120 façons de choisir 3 folds de test parmi 10.",
      domainStats: "Statistiques et science des données",
      domainStatsDesc: "Les tests d'hypothèse, intervalles de confiance et posterieurs bayésiens sont tous construits sur Gamma et Bêta.",
      domainStatsEx1: "La distribution du chi-deux avec k degrés de liberté est un Gamma(k/2) mis à l'échelle. Pour k=10 : Gamma(5) = 24.",
      domainStatsEx2: "Un intervalle crédible bayésien à 95% pour une proportion utilise les quantiles de B(a,b).",
      domainStatsEx3: "Tests de permutation : nombre de façons d'assigner 12 sujets à 2 groupes de 6 = C(12,6) = 924.",
      domainPhysics: "Physique et ingénierie",
      domainPhysicsDesc: "Mécanique quantique, mécanique statistique et traitement du signal utilisent constamment Gamma et les factorielles doubles.",
      domainPhysicsEx1: "Théorème de Wick en QFT : les contractions de n champs impliquent (n-1)!! appariements. Pour 7 champs : 7!! = 105.",
      domainPhysicsEx2: "Volume de la sphère unitaire en 6 dimensions : V₆ = π³/Gamma(4) = π³/6 ≈ 5,1677.",
      domainPhysicsEx3: "Oscillateur harmonique quantique : le niveau d'énergie n a des facteurs de normalisation n!!.",
      domainBio: "Biologie et bioinformatique",
      domainBioDesc: "L'analyse de séquences, la phylogénétique et la génétique des populations utilisent les factorielles généralisées.",
      domainBioEx1: "Permutations de séquences ADN : nombre d'ordonnements distincts de 10 nucléotides = 10! = 3 628 800.",
      domainBioEx2: "Comptage de k-mères : choisir 3 positions dans un 20-mer = C(20,3) = 1140 k-mères possibles.",
      domainBioEx3: "Les modèles de fréquences alléliques utilisent la distribution Bêta comme prior conjugué.",
      domainEveryday: "Vie quotidienne",
      domainEverydayDesc: "Les cotes de loterie, arrangements de table et estimations de probabilités impliquent toutes ces fonctions.",
      domainEverydayEx1: "Cotes de loterie : choisir 6 numéros sur 49 donne C(49,6) = 13 983 816 tickets possibles.",
      domainEverydayEx2: "Placer 8 convives autour d'une table ronde : (8-1)! = 7! = 5040 arrangements.",
      domainEverydayEx3: "Estimer un taux de succès de 30% sur 10 essais : ta croyance prior suit B(3,7).",
    ...
    de: {
      ...
      domainCSDesc: "Sortieren, Suchen und kombinatorische Optimierung basieren auf Fakultäten und Binomialkoeffizienten.",
      domainCSEx1: "Das Sortieren von n Elementen erkundet bis zu n! Permutationen — 52! ≈ 8×10⁶⁷ mögliche Anordnungen eines Kartenspiels.",
      domainCSEx2: "Brute-Force TSP für 20 Städte: 20! ≈ 2,4×10¹⁸ Routen zu prüfen.",
      domainCSEx3: "Feature Selection: 5 Features aus 20 Kandidaten wählen = C(20,5) = 15504 Kombinationen.",
      domainAI: "Künstliche Intelligenz und maschinelles Lernen",
      domainAIDesc: "Bayessche Inferenz, Modellauswahl und generative Modelle stützen sich stark auf Gamma- und Betafunktionen.",
      domainAIEx1: "Bayesscher A/B-Test: nach 8 Erfolgen und 4 Misserfolgen folgt deine Überzeugung über die Konversionsrate B(8,4).",
      domainAIEx2: "Variationelle Inferenz minimiert die KL-Divergenz mit Gamma(z) als Normalisierungskern.",
      domainAIEx3: "Kreuzvalidierung: C(10,3) = 120 Möglichkeiten, 3 Test-Folds aus 10 zu wählen.",
      domainStats: "Statistik und Datenwissenschaft",
      domainStatsDesc: "Hypothesentests, Konfidenzintervalle und bayessche Posteriori basieren auf Gamma und Beta.",
      domainStatsEx1: "Die Chi-Quadrat-Verteilung mit k Freiheitsgraden ist ein skaliertes Gamma(k/2). Für k=10: Gamma(5) = 24.",
      domainStatsEx2: "Ein 95%-bayessches Konfidenzintervall für eine Proportion verwendet B(a,b)-Quantile.",
      domainStatsEx3: "Permutationstests: Anzahl der Möglichkeiten, 12 Probanden in 2 Gruppen à 6 zu verteilen = C(12,6) = 924.",
      domainPhysics: "Physik und Ingenieurwesen",
      domainPhysicsDesc: "Quantenmechanik, Statistische Mechanik und Signalverarbeitung nutzen ständig Gamma und Doppelfakultäten.",
      domainPhysicsEx1: "Wick-Satz in der QFT: Kontraktionen von n Feldern erfordern (n-1)!! Paarungen. Für 7 Felder: 7!! = 105.",
      domainPhysicsEx2: "Volumen der 6-dimensionalen Einheitssphäre: V₆ = π³/Gamma(4) = π³/6 ≈ 5,1677.",
      domainPhysicsEx3: "Quanten-Harmonischer Oszillator: Energieniveau n hat n!!-Normalisierungsfaktoren.",
      domainBio: "Biologie und Bioinformatik",
      domainBioDesc: "Sequenzanalyse, Phylogenetik und Populationsgenetik nutzen verallgemeinerte Fakultäten.",
      domainBioEx1: "DNA-Sequenz-Permutationen: Anzahl der unterscheidbaren Anordnungen von 10 Nukleotiden = 10! = 3.628.800.",
      domainBioEx2: "K-Mer-Zählung: 3 Positionen aus einem 20-mer wählen = C(20,3) = 1140 mögliche 3-mere.",
      domainBioEx3: "Allel-Frequenzmodelle nutzen die Beta-Verteilung als konjugierten Prior für binomiale Likelihoods.",
      domainEveryday: "Alltag",
      domainEverydayDesc: "Lottoquoten, Sitzordnungen und Wahrscheinlichkeitsberechnungen verwenden all diese Funktionen.",
      domainEverydayEx1: "Lottoquoten: 6 Zahlen aus 49 wählen ergibt C(49,6) = 13.983.816 mögliche Tippscheine.",
      domainEverydayEx2: "8 Gäste um einen runden Tisch setzen: (8-1)! = 7! = 5040 Anordnungen.",
      domainEverydayEx3: "Einschätzung einer 30% Erfolgsrate bei 10 Versuchen: dein Prior folgt B(3,7).",
